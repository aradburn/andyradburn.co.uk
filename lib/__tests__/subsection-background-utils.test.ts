...
describe("getBackgroundImage", () => {
    it("returns about background-image from config.about", () => {
        ...
        expect(getBackgroundImage(config as never, "about")).toBe(
            "about-bg.jpg",
        );
    });
    ...
    it("returns background-image from posts block", () => {
        ...
        expect(getBackgroundImage(config as never, "posts")).toBe(
            "posts-bg.jpg",
        );
    });
    ...
    it("returns background-image from gigs and videos blocks", () => {
        ...
        expect(getBackgroundImage(configWithGigs as never, "gigs")).toBe(
            "gigs-bg.jpg",
        );
        ...
        expect(getBackgroundImage(configWithVideos as never, "videos")).toBe(
            "videos-bg.jpg",
        );
    });
});
