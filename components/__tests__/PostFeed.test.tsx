...
describe("PostFeedItem", () => {
    ...
    it("renders excerpt when no description", () => {
        const postNoDesc = {
            ...mockPost,
            frontMatter: { ...mockPost.frontMatter, description: undefined },
        };
    ...
    it("renders external link when external_url exists", () => {
        ...
        const link = screen.getByRole("link", {
            name: /Read more on External Site/,
        });
    ...
    it("renders full content when contentHtml provided", () => {
        render(
            <PostFeedItem post={mockPost} contentHtml="<p>Full content</p>" />,
        );
    ...
    it("uses image_alt when provided, else title", () => {
        const postNoAlt = {
            ...mockPost,
            frontMatter: { ...mockPost.frontMatter, image_alt: undefined },
        };
