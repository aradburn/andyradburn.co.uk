...
import { buildMetadataForSection, getDiscographyPosts } from "@/lib/data";
import "../discography-styles.css";
import { markdownToHtml } from "@/lib/markdown";
import { DiscographyEntry } from "@/components/PostFeed";

export async function generateMetadata(): Promise<Metadata> {
    return buildMetadataForSection("discography");
}
...
export default async function DiscographyPage() {
    ...
    return (
        ...
        >
            <header
                className="mx-auto min-w-0 sm:min-w-sm md:min-w-md lg:min-w-lg xl:min-w-5xl max-w-full sm:max-w-max
