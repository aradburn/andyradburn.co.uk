...
export default function AboutPage() {
    return (
        <div className="mx-auto w-sm sm:w-xl md:w-3xl lg:w-5xl xl:w-7xl max-w-full min-h-[60vh] min-h-full px-8 py-8 sm:py-20 flex flex-col overflow-hidden bg-gradient-to-b from-black/20 to-black/66">
            ...
            <p className="mb-4">
                Andy Radburn is a synthesizer player and composer living in
                Portsmouth, UK.
            </p>
            <p className="mb-4">
                Currently playing in Dubbal, Sonic Arcana, Kev Ellis and the
                Space Cadets, Shankara, and Thee CROW.
            </p>
            ...
            <ul className="mb-6 list-disc pl-10">
                <li>
                    <a
                        href="https://www.youtube.com/@aradburn"
                ...
                <li>
                    <a
                        href="https://www.youtube.com/@SonicArcanaMusic"
                        className="inline-flex items-center gap-2 text-accent"
                    >
                ...
                <li>
                    <a
                        href="https://www.youtube.com/@Dubbal"
                        className="inline-flex items-center gap-2 text-accent"
                    >
                        Dubbal on YouTube
                        <SocialIcon
                ...
                <li>
                    <a
                        href="https://www.mixcloud.com/SonicArcana/"
                        className="inline-flex items-center gap-2 text-accent"
                    >
        ...
        */}
                <li>
                    <a
                        href="https://sonicarcana.bandcamp.com/"
                        className="inline-flex items-center gap-2 text-accent"
                    >
                ...
                <li>
                    <a
                        href="https://kevellis.bandcamp.com"
                        className="inline-flex items-center gap-2 text-accent"
                    >
                        Dubbal on BandCamp
                        <SocialIcon
